...
public class parserInterprete extends Parser {
	...
	@Override
	public String getGrammarFileName() { return "G4/parserInterprete.g4"; }
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << PIZQ) | (1L << CORCHETEIZQ) | (1L << LET) | (1L << RETURN) | (1L << TRUE) | (1L << FALSE) | (1L << LEN) | (1L << FIST) | (1L << LAST) | (1L << REST) | (1L << PUSH) | (1L << FN) | (1L << PUTS) | (1L << IF) | (1L << INTEGER) | (1L << ID) | (1L << STRING))) != 0)) {
				{
				{
				setState(56);
				statement();
